...
namespace Parfu.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        //constructor
        public ProductsController(ParfuContext context, IWebHostEnvironment webHostEnvironment)
        {
        ...
        {
            //lista cu categorii atunci cand se creeaza produsul
        ...
        public async Task<IActionResult> Create(Product product) //id e route parameter din Index.cshtml
        {
            ViewBag.CategoryId = new SelectList(context.Categories.OrderBy(x => x.Sorting), "Id", "Name");
            ...
            if (ModelState.IsValid)
            {
                ...
                product.Image = imageName;//daca da eroare come here 
